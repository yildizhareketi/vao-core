            ...
            @if(\Illuminate\Support\Facades\Config::has('menu') || \Illuminate\Support\Facades\Config::has('theme.menu'))
                ...
                @foreach($menu as $item)
                    @if(array_key_exists('role',$item))
                        ...
                        <li class="menu-item {{ VaoCore::helpers()->isMenuOpen($item) ? 'menu-item-open' : '' }} {{ '/' . request()->path() == $item['link'] ? 'menu-item-active' : '' }} {{ isset($item['children']) && $item['children'] ? 'menu-item-submenu':null }}"
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        @foreach($item['children'] as $childItem)
                                            <li class="menu-item {{ '/' . request()->path() == $childItem['link'] ? 'menu-item-active' : '' }} menu-item-submenu" aria-haspopup="true"
                    ...
                    @else
                        ...
                        @else
                            ...
                            <li class="menu-item {{ VaoCore::helpers()->isMenuOpen($item) ? 'menu-item-open' : '' }} {{ '/' . request()->path() == $item['link'] ? 'menu-item-active' : '' }} {{ isset($item['children']) && $item['children'] ? '
m-submenu':null }}"
                                aria-haspopup="true" {{ isset($item['children']) && $item['children'] ? 'data-menu-toggle="hover" ':null }}>
                                <a href="{{ isset($item['children']) && $item['children'] ? 'javascript:;':$item['link'] }}"
                                   class="menu-link {{ isset($item['children']) && $item['children'] ? 'menu-toggle':null }}">
